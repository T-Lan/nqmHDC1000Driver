...
module.exports = (function() {
  ...
  function cozir(config) {
    ...
    this._config = config;
    //this._serialPort = null; --but what do i do here?
  ...
  wire.writeByte (0x22,function (err){
    if(err)
    {
      console.log ("error");
    } 
...
//This is for serial port communication
  ...
  //polling functions for timing the data input
  /*
